...
class CardTitle extends React.Component {
  ...
  render () {
    return (
      <div>
        { this.props.cardName ? <div onClick={this.handleOpenModal} className="card-item__name">{ this.props.cardName }
          <button onClick={this.handleDeleteCard} className="column__del-card">&times;</button>
        </div> : <div onClick={this.handleOpenModal} className="card-item__name">
          <input
